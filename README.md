...
```rust
# use rasn::{AsnType, types::{Constructed, Field, Fields}};
...
#          Field::new_required(Utf8String::TAG),
#          Field::new_required(Integer::TAG),
#     ]);
# }
...
impl Encode for Person {
    fn encode_with_tag_and_constraints<E: Encoder>(&self, encoder: &mut E, tag: Tag, constraints: Constraints) -> Result<(), E::Error> {
        ...
        encoder.encode_sequence::<Self, _>(tag, constraints, |encoder| {
