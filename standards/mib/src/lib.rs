...
pub const MIB: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB;
pub const SYSTEM: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_SYSTEM;
pub const INTERFACES: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_INTERFACES;
pub const AT: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_AT;
pub const IP: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_IP;
pub const ICMP: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_ICMP;
pub const TCP: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_TCP;
pub const UDP: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_UDP;
pub const EGP: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_EGP;
pub const TRANSMISSION: ConstOid =
    Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_TRANSMISSION;
pub const SNMP: ConstOid = Oid::ISO_IDENTIFIED_ORGANISATION_DOD_INTERNET_MGMT_MIB_SNMP;
...
pub mod interfaces {
    ...
    object_type! {
        ...
        /// `OBJECT IDENTIFIER { 0 0 }`, which is a syntatically valid object
...
pub mod address {
    ...
    object_type! {
        ...
        /// object. That is, it effectively dissasociates the interface
...
///
/// Implementation of the IP groupd is mandatory for all systems.
pub mod ip {
    use super::*;
    ...
    object_type! {
        ...
        /// is, it effectively dissasociates the interface identified with said
