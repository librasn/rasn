...
pub const CHARACTERISTIC_TWO_FIELD: &Oid = Oid::ISO_MEMBER_BODY_US_ANSI_X962_FIELD_TYPE_CHARACTERISTIC_TWO_FIELD;
pub const ID_CHARACTERISTIC_TWO_BASIS: &Oid = Oid::ISO_MEMBER_BODY_US_ANSI_X962_FIELD_TYPE_CHARACTERISTIC_TWO_FIELD_BASIS;
pub const GN_BASIS: &Oid = Oid::ISO_MEMBER_BODY_US_ANSI_X962_FIELD_TYPE_CHARACTERISTIC_TWO_FIELD_BASIS_TP;
...
pub const ID_KEY_EXCHANGE_ALGORITHM: &Oid = Oid::JOINT_ISO_ITU_T_COUNTRY_US_ORGANIZATION_GOV_CSOR_INFOSEC_ALGORITHMS_KEY_EXCHANGE;
