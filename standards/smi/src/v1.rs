...
macro_rules! common_impls {
    ($name:ident, $network_type:ty, $access_variant:ident, $status_variant:ident, $const_oid:expr) => {
        ...
        impl $crate::v1::ObjectType for $name {
            type Syntax = $network_type;
            const ACCESS: $crate::v1::Access = $crate::v1::Access::$access_variant;
            const STATUS: $crate::v1::Status = $crate::v1::Status::$status_variant;
...
macro_rules! opaque_impls {
    ($name:ident) => {
        impl core::convert::TryFrom<$crate::v1::Opaque> for $name {
            type Error = $crate::rasn::ber::de::Error;

            fn try_from(value: $crate::v1::Opaque) -> Result<Self, Self::Error> {
                $crate::rasn::ber::decode(value.as_ref())
            }
        }

        impl core::convert::TryFrom<$name> for $crate::v1::Opaque {
        ...
        impl $crate::rasn::Decode for $name {
            fn decode_with_tag<D: $crate::rasn::Decoder>(decoder: &mut D, tag: Tag) -> Result<Self, D::Error> {
                $crate::v1::Opaque::decode_with_tag(decoder, tag)
...
macro_rules! object_type {
    (
        ...
        $crate::common_impls!($name, $crate::v1::Opaque, $access_variant, $status_variant, $const_oid);
    ...
    (
        ...
        impl $crate::rasn::Decode for $name {
            fn decode_with_tag<D: $crate::rasn::Decoder>(decoder: &mut D, tag: Tag) -> Result<Self, D::Error> {
                ...
                let syntax = $crate::v1::ObjectSyntax::decode_with_tag(decoder, tag)?;
